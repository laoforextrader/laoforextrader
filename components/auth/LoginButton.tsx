  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      <button
        ...
        style={{
          width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 10,
          padding: "12px 20px", background: "#1877F2", border: "1.5px solid #1877F2",
          borderRadius: 10, fontSize: 14, fontWeight: 600, color: "#fff",
          cursor: "pointer", transition: "all 0.2s", fontFamily: "'Noto Sans Lao', sans-serif",
        }}
        onMouseOver={e => { (e.currentTarget as HTMLElement).style.background = "#166FE5"; (e.currentTarget as HTMLElement).style.borderColor = "#166FE5" }}
        onMouseOut={e => { (e.currentTarget as HTMLElement).style.background = "#1877F2"; (e.currentTarget as HTMLElement).style.borderColor = "#1877F2" }}
      >
