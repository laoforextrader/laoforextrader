      ...
      <div className="max-w-[1060px] mx-auto px-6 py-10">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4">
            <PriceBox plan="1m" period="1 ເດືອນ"  lak="250,000"   usdt="$12" selected={plan === "1m"} />
            <PriceBox plan="3m" period="3 ເດືອນ"  lak="600,000"   usdt="$28" save="ປະຢັດ 150k" selected={plan === "3m"} />
            <PriceBox plan="6m" period="6 ເດືອນ"  lak="1,100,000" usdt="$51" save="ປະຢັດ 400k" selected={plan === "6m"} />
            <PriceBox plan="1y" period="1 ປີ"      lak="2,000,000" usdt="$93" save="ປະຢັດ 1M" highlight selected={plan === "1y"} />
          </div>
          <div
...
function PriceBox({
  plan, period, lak, usdt, save, highlight, selected,
}: {
  plan: string
  period: string
  lak: string
  ...
  return (
    <Link
      href={`/signal/trs-signal-pro/payment?plan=${plan}`}
      scroll={false}
