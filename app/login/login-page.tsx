        ...
        <div className="card p-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3
                       ...
                       hover:bg-gray-50 active:bg-gray-100 transition-colors shadow-sm mb-3"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3
                       bg-[#1877F2] text-white font-medium text-sm py-3.5 rounded-lg
                       hover:bg-[#166FE5] active:bg-[#1464D6] transition-colors shadow-sm mb-6"
          >
